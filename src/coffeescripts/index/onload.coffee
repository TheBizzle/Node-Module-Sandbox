  ...
  [Obj, $, _] = [require('../adt/obj'), require('../api/jquery'), require('../api/underscore')]

  [Cards, Element]    = [require('./cards'),   require('./element')]
  [globals, $globals] = [require('./globals'), require('./jglobals')]
  [Index, Services]   = [require('./main'),    require('./services')]
